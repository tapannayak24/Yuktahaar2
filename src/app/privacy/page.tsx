...
export default function Privacy() {
  return (
    <Container>
      <SectionTitle preTitle="Legal" title="Privacy Policy">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          Welcome to Yuktahaar. This Privacy Policy explains how we collect,
        ...
        <ul>
          <li>
            ...
            and other information you provide when using our services or joining
            our WhatsApp groups.
          </li>
          <li>
            <strong>Order Information:</strong> Details about the products you
            order, including quantity and frequency.
          </li>
          <li>
            <strong>Communication Data:</strong> Information from your
            interactions with us via WhatsApp, email, or phone.
          </li>
          <li>
            <strong>Payment Information:</strong> Details related to your
            payments, though we do not store complete credit card information.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>With Producers:</strong> We may share your order information
            with our partner farmers and producers to fulfill your orders.
          </li>
          <li>
        ...
        <p>
          ...
          information. You can also opt out of our communications at any time.
        </p>
